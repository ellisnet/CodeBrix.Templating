...
partial class ScriptObject : IDictionary<string, object>, IEnumerable, IScriptObject, IDictionary, IFormattable
{
    ...
    [UnconditionalSuppressMessage("Trimming", "IL2026", Justification = "Auto-import of static members from derived types; derived types within CodeBrix.Templating are statically known.")]
    ...
    /// <summary><c>ContainsKey</c>.</summary>
