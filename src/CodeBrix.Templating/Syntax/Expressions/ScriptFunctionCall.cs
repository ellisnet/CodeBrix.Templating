...
/// <summary><c>ScriptFunctionCall</c>.</summary>
...
partial class ScriptFunctionCall : ScriptExpression
{
    ...
    /// <summary><c>MaximumParameterCount</c>.</summary>
    ...
    /// <summary><c>OpenParent</c>.</summary>
    ...
    /// <summary><c>ExplicitCall</c>.</summary>
    public bool ExplicitCall { get; set; }
    /// <summary><c>TryGetFunctionDeclaration</c>.</summary>
    ...
    /// <summary><c>AddArgument</c>.</summary>
    ...
    /// <summary><c>GetScientificExpression</c>.</summary>
    ...
    /// <summary><c>IsFunction</c>.</summary>
