...
partial class TemplateContext
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="T:CodeBrix.Templating.TemplateContext" /> class.
    /// </summary>
...
#pragma warning restore RS1035
    ...
    /// <summary>
    /// Gets the current output of the template being rendered (via <see cref="Template.Render(CodeBrix.Templating.TemplateContext)"/>)/>.
    /// </summary>
    ...
    /// <summary><c>CurrentSpan</c>.</summary>
    ...
    /// <summary><c>EnterRecursive</c>.</summary>
    ...
    /// <summary><c>ExitRecursive</c>.</summary>
    ...
    /// <summary><c>ResetPreviousNewLine</c>.</summary>
    public void ResetPreviousNewLine()
    {
        _previousTextWasNewLine = false;
    }
    /// <summary><c>GetTemplatePathFromName</c>.</summary>
    ...
    /// <summary><c>ConvertTemplateNameToPath</c>.</summary>
    ...
    /// <summary><c>GetOrCreateTemplate</c>.</summary>
    ...
    /// <summary><c>CreateTemplate</c>.</summary>
    ...
    /// <summary><c>RenderTemplate</c>.</summary>
...
{
    /// <summary><c>LiquidTemplateContext</c>.</summary>
