...
partial class ScriptPrinter
{
    ...
    /// <summary><c>ScriptPrinter</c>.</summary>
    ...
    /// <summary><c>PreviousHasSpace</c>.</summary>
    public bool PreviousHasSpace => _previousHasSpace;
    /// <summary><c>IsInWhileLoop</c>.</summary>
    ...
    /// <summary><c>ExpectSpace</c>.</summary>
    public ScriptPrinter ExpectSpace()
    {
        _expectSpace = true;
        return this;
    }
    /// <summary><c>WriteListWithCommas</c>.</summary>
    ...
    /// <summary><c>WriteEnterCode</c>.</summary>
    ...
    /// <summary><c>WriteExitCode</c>.</summary>
