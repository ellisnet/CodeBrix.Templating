...
partial class ArrayFunctions : ScriptObject
{
    ...
    /// <summary>
    /// Attempts to apply a CodeBrix.Templating function to a list and returns the results as a ScriptRange
    /// </summary>
    /// <remarks>
    /// Encapsulates a common approach to parameter checking for any method that will take a CodeBrix.Templating function and apply it to a list
    /// </remarks>
