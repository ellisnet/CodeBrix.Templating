...
class StringFunctions : ScriptObject
{
    ...
    /// <remarks>
    /// ```scriban-html
    /// {{ "CodeBrix.Templating" | string.equals_ignore_case "SCRIBAN" }}
    /// ```
    /// ```html
    /// true
    /// ```
    ...
    /// <summary><c>ReplaceFirst</c>.</summary>
    [ScriptMemberIgnore]
