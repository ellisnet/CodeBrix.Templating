================================================================================
README-INDEX: CodeBrix.Templating
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Templating.BsdLicenseForever — text-templating and scripting
      engine for the Scriban and Liquid template languages.
